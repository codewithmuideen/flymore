...
export default function Recommend() {
  const data = [
    {
      ...
      title: "Singapore",
      subTitle: "Singapore, officialy thr Republic of Singapore.",
      cost: "38,800",
  ...
  return (
    <Section id="recommend" style={{paddingTop:'5%'}}>
      <div className="title">
        <h2 style={{fontFamily:'Tahoma',fontWeight:'700', fontSize:"30px"}}>Destinations</h2>
      </div>
